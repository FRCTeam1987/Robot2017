...
BoilerSidePegRed::BoilerSidePegRed() {
	...
	AddSequential(new SetDesiredAngle(12));
...
//	AddSequential(new DriveArcPower(false, -50));
	AddSequential(new DriveStraight(-180, 0, -.95));
	AddSequential(new DriveStraight(0, 0, 0));
	AddSequential(new DriveRotate(-45));
	AddSequential(new DriveStraight(-70, 0, -.7));
	AddSequential(new DriveStraight(0, 0, 0));
